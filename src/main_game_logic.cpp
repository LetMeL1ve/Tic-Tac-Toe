...
{
    void print_field(const char field[][field_size]) { // Method that prints formated field to standart output.
    ...
    int check_field(const char field[][3]) { // Returns -1 if X wins, returns 1 if O wins else returns 0.
        bool result;
    ...
    void player_move(int field[][3]) { // Method that update field.
        while (true) {
